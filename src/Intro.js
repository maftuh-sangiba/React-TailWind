            ...
            <div className="container mx-auto my-auto bg-gray-700 sm:rounded-xl sm:shadow p-8 m-10">
                <div className="flex flex-col md:flex-row">
                    <div class="basis-auto md:basis-1/4">
                        ...
                        <img className="rotate-12 scale-50 transition delay-150 hover:rotate-0 hover:scale-75 duration-500" src="https://planetanft.com/wp-content/uploads/2021/12/Doodles-1.png" alt="profile" />
                    </div>
                    <div class="basis-auto my-auto md:basis-3/4 space-y-4 pr-0 md:pr-10">
